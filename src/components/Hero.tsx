    ...
    <div className="p-2">
      ...
      <div className="relative z-20 flex h-full items-center px-[34px] pt-[34px]">
        <div className="max-w-[630px]">
          <h1 className="text-[56px] md:text-[72px] font-bold uppercase leading-[0.96] tracking-[-0.04em] text-white">
            Регистрация
            <br />
            фармацевтической
            <br />
          ...
          <p className="mt-[16px] max-w-[600px] text-[20px] font-medium leading-[1.35] text-white">
            Сопровождение регистрации лекарственных средств <br />
            и медицинских изделий, включая клинические исследования.
          </p>

          <a
            href="#contact"
            className="mt-[22px] inline-flex rounded-2xl bg-[#0B2A34] px-[22px] py-[12px] text-[20px] font-medium text-white shadow-[0_10px_24px_rgba(0,0,0,.18)] transition hover:bg-[#009B72]"
          >
