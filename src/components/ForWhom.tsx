      ...
      <div className="mx-auto max-w-[1120px] text-center">
        ...
        <h2
          className={`
            ...
            transition-all duration-700 delay-75 ease-[cubic-bezier(.22,1,.36,1)]
            ${
              visible
                ? "translate-y-0 opacity-100 blur-0"
          ...
          {cards.map((card, index) => (
            <article
              ...
              className={`
                ...
                hover:shadow-[0_22px_44px_rgba(11,42,52,0.18)]
                sm:px-[34px]
                md:min-h-[204px]
                ${
                  visible
            ...
            >
              ...
              <img
                ...
                className="
                  ...
                  group-hover:-translate-y-[3px] group-hover:scale-110
                "
              />
              ...
              <div className="absolute inset-x-[24px] bottom-0 h-[2px] origin-center scale-x-0 rounded-full bg-[#009B72] transition-transform duration-500 ease-[cubic-bezier(.22,1,.36,1)] group-hover:scale-x-100" />
            </article>
          ))}
        </div>
      </div>
