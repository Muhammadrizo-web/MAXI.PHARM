...
const steps = [
  ...
  },
  {
    ...
    text: "Организация и сопровождение клинических исследований в рамках регистрационного процесса в соответствии с действующимиормативными нормативных требованиями",
    side: "right",
  },
];
